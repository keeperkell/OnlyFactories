...
const LineC = () => {
  ...
  const getDaysQ = async () => {
    //local
    //const response2 = await fetch(`http://localhost:3306/api/getDaysQ/`);
    //server
    const response2 = await fetch(`https://onlyfactories.duckdns.org:3306/api/getDaysQ/`);
